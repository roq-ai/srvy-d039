  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the power of efficient research with Srvy - crafting interactive surveys, reaching your target audience, and analyzing results seamlessly for insightful outcomes."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the power of efficient research with Srvy - crafting interactive surveys, reaching your target audience, and analyzing results seamlessly for insightful outcomes.`}
            </Text>
            <Box
